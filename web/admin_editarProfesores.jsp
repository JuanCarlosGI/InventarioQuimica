<%-- 
    Document   : admin_editarProfesores
    Created on : 20-nov-2016, 13:47:25
    Author     : armando
--%>
  ...
  <html>
    ...
    <body>
      ...
      <ul id="dropdown1" class="dropdown-content">
        ...
        <li class="divider"></li>
        <li><a href="admin_editarPerfil.jsp">Salir</a></li>
      </ul>
      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <ul class="side-nav" id="mobile-demo">
            <li><a href="./admin_editarProfesores.jsp">Perfil</a></li>
    ...
    <div class="nav-wrapper center">
      <div class="col s12">
        ...
        <a class="breadcrumb">Editar Profesores</a>
      </div>
    </div>
  </nav>
  <!-- NAVBAR END-->

  <form action="addProfesor" method="post">
