<%-- 
    Document   : admin_editarAdministradores
    Created on : 20-nov-2016, 13:56:14
    Author     : armando
--%>
...
<!DOCTYPE html>
  ...
  <body>
    <form action="addAdministrador" method="post">
    ...
    <div class="row">
      ...
      <div class="card col s8 m6 l4">
        <div class="card-content center">
          <span class="card-title activator grey-text text-darken-4">AGREGAR ADMINISTRADOR</span>
        </div>
