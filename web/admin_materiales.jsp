<%-- 
    Document   : admin_materiales
    Created on : Nov 20, 2016, 7:06:31 PM
    Author     : Cesar
--%>
...
<!DOCTYPE html>
  <html>
    ...
    <div class="nav-wrapper center">
      <div class="col s12">
        ...
        <a class="breadcrumb">Materiales</a>
      </div>
    </div>
  </nav>
  <!-- NAVBAR END-->
  ...
  <body>
      ...
      <div class="container">
        ...
        <form action="addMaterial" method = "post">
          <div class="row">
            ...
            <div class="input-field col s6">
              <input required placeholder="Big Mac" type="text" class="validate" id="capacidad" name="capacidad"/>
          ...
          <div class='section'>
            ...
            <button class="btn waves-effect waves-light" type="submit" name="action">Agregar Material
    ...
    <table class="responsive-table striped" style="width: 100%">
        ...
        <tbody>
          <%
            LinkedList<Material> materiales= (LinkedList<Material>)request.getAttribute("materiales");
            for(int i = 0; i < materiales.size(); i+=1){
          ...
          <tr>
            ...
            <td>
                <a href="modificarMaterial?clave=<%=materiales.get(i).getClave()%>&action=borrar"><button class="btn waves-effect waves-light red" name="action"><i class="material-icons center">delete</i></button></a>
            </td>
          </tr>
          <%
            }
