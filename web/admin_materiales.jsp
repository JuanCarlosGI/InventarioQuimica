    ...
    <div class="row">
      ...
      <div class="card col s8 m6 l4">
        <div class="card-content center">
          <span class="card-title activator grey-text text-darken-4">AGREGAR MATERIAL</span>
        </div>
        <div class="card-reveal center">
            <input placeholder="Nombre del material" type="text" class="validate" id="matricula" name="matricula"/>
        </div>
      </div>
    </div>
