...
public class DetalleEquipo {
    ...
    /**
     * Regresa el valor de equipoId.
     * @return El valor de equipoId.
     */
    public final String getEquipoId() {
        return equipoId;
    }

    /**
     * Asigna el valor de equipoId.
     * @param nuevoEquipoId En nuevo valor de equipoId.
     */
    public final void setEquipoId(final String nuevoEquipoId) {
